---
name: "setup-cowork"
description: "Guided first-time Cowork setup that walks the user through five steps — pick a role, install role-matched plugins, connect tools and connectors, try a skill, and wrap up. Use when the user wants to set up, configure, or get started with Cowork — phrases like 'set up cowork', 'help me get started', 'configure cowork', 'I am new here', 'onboard me', 'get me set up', 'install plugins for my role', or 'connect my tools'. Do not use for building or customizing a specific plugin (the plugin-management skills cover that) or for wiring up a single connector mid-task."
---
