...
For the complete styling guide — third-party library recommendations (MUI, Radix, Tailwind, Recharts, D3, Phosphor Icons, dnd-kit), Tailwind CSS setup with the Airtable toolkit preset, CSS import approaches, the toolkit color resolution system, dark mode configuration, and CVA variant styling — read `references/styling-guide.md`.
...
- `references/styling-guide.md` — Third-party libraries, Tailwind setup, color system, dark mode, CVA
